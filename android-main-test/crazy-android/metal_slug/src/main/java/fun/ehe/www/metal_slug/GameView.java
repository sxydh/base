package fun.ehe.www.metal_slug;
...
import fun.ehe.www.metal_slug.comp.MonsterManager;
import fun.ehe.www.metal_slug.comp.Player;
        ...
        switch (step) {
            case INIT:
                ...
                if (gameLayout == null) {
                    ...
                    // 设置按钮的背景图片
                    button.setBackground(getResources().getDrawable(R.mipmap.left));
                    RelativeLayout.LayoutParams params = new RelativeLayout
                    ...
                    // 设置按钮的背景图片
                    button.setBackground(getResources().getDrawable(R.mipmap.right));
                    ...
                    // 设置按钮的背景图片
                    button.setBackground(getResources().getDrawable(R.mipmap.fire));
                    params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
                    ...
                    button = new Button(mainContext);
                    // 设置按钮的背景图片
                    button.setBackground(getResources().getDrawable(R.mipmap.jump));
                    params = new RelativeLayout.LayoutParams(
                            LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
